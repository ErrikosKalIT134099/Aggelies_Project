...
namespace WindowsFormsApp1
{
    public partial class Main_Page : Form
    {
        ...
        public Main_Page()
        {
            ...
            dataGridView1.Columns["REPORT"].DisplayIndex = 6;
            dataGridView1.Columns["FAVORITE"].DisplayIndex = 5;
            dataGridView1.Columns["DETAILS"].DisplayIndex = 4;
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                if (Login.uname.Equals(""))
                {
               
                    label2.Text ="you must login to add to favorites";
                   
                }else
                {
                    //var id = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value);
                    // label2.Text = id.ToString();
                    var test = Convert.ToString(dataGridView1.Rows[e.RowIndex].Cells[4].Value);
                    //int User_id = 3;
                    label2.Text = "you must login to add to favorites";
              ...
              e.RowIndex >= 0 && e.ColumnIndex == 2)
            {
                //var id = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value);
                // label2.Text = id.ToString();
                var test = Convert.ToString(dataGridView1.Rows[e.RowIndex].Cells[3].Value);
                //int User_id = 3;
                label2.Text = test;
                Report rep = new Report();
                rep.txtAddsName.Text = test;
                rep.ShowDialog();
        ...
        private void dataGridView1_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            if (e.ColumnIndex == 2)
            {
                ...
                var w = Properties.Resources.reportImg.Width;
                var h = Properties.Resources.reportImg.Height;
                var x = e.CellBounds.Left + (e.CellBounds.Width - w) / 2;
                var y = e.CellBounds.Top + (e.CellBounds.Height - h) / 2;

                e.Graphics.DrawImage(Properties.Resources.reportImg, new Rectangle(x, y, w, h));
                e.Handled = true;
            }
            ...
            if (e.ColumnIndex == 1)
            {
                ...
                var w = Properties.Resources.someimage2.Width;
                var h = Properties.Resources.someimage2.Height;
                var x = e.CellBounds.Left + (e.CellBounds.Width - w) / 2;
                var y = e.CellBounds.Top + (e.CellBounds.Height - h) / 2;

                e.Graphics.DrawImage(Properties.Resources.someimage2, new Rectangle(x, y, w, h));
                e.Handled = true;
            }
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                var w = Properties.Resources.detailsimg.Width;
                var h = Properties.Resources.detailsimg.Height;
                var x = e.CellBounds.Left + (e.CellBounds.Width - w) / 2;
                var y = e.CellBounds.Top + (e.CellBounds.Height - h) / 2;

                e.Graphics.DrawImage(Properties.Resources.detailsimg, new Rectangle(x, y, w, h));
                e.Handled = true;
            }
        }
