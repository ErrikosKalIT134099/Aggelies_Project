...
namespace WindowsFormsApp1
{
    public partial class Welcome_Page : Form
    {
        ...
        {
            Main_Page mp = new Main_Page();
            //mp.dataGridView1.DataSource = null;
            //mp.dataGridView1.Columns["REPORT"].DisplayIndex = 0;
            ///mp.dataGridView1.Columns["FAVORITE"].DisplayIndex = 1;
            //mp.dataGridView1.Columns["DETAILS"].DisplayIndex = 2;
